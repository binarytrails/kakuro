...
{\bf Outcomes:} Had a demo ready application, which uses a SQLite database, where we can load different levels, save the state of the game, and load them. Total time worked this week: 25 hours. \\
